...
from scrape_schema.base import BaseField, BaseSchema, MARKUP_TYPE
...
class TypingSchema(BaseSchema):
    ...
    val_5 = MockField([1, 2, 3, "a"],
                      filter_=lambda i: isinstance(i, int),
                      factory=sum)
    ...
    a_val_19: Annotated[list[str], MockField("foobar", factory=list)]  # str ignored typing, - cast manual
    # filter
    f_val_1: Annotated[list[int], MockField([1, 10, 100, 2, 9, 5],
                                            filter_=lambda i: i <= 10)]
    f_val_2: Annotated[list[int], MockField(["lorem", "3", "upsum", "dolor", "1", "2"],
                                            filter_=lambda s: s.isdigit())]
    f_val_3: Annotated[list[str], MockField(["lorem", "3", "upsum", "dolor", "1", "2"],
